...
def footer_links():
    ...
    columns = [
        (FooterLink.COLUMN_INFO, '����������'),
        (FooterLink.COLUMN_SUPPORT, '������ ���������'),
        (FooterLink.COLUMN_ADDITIONAL, '�������������'),
    ]
    return render_template(
...
def footer_link_new():
    ...
    display_choices = [
        (FooterLink.DISPLAY_MODAL, '� ��������� ���� (Bootstrap modal)'),
        (FooterLink.DISPLAY_PAGE, '�� ��������� �������� (/page/<slug>)'),
    ]
    return render_template(
